...
import kz.gelleson.findep.domain.JobHistory;
import kz.gelleson.findep.service.JobHistoryService;
...
/**
 * REST controller for managing {@link kz.gelleson.findep.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
