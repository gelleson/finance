...
import kz.gelleson.findep.domain.Location;
import kz.gelleson.findep.service.LocationService;
...
/**
 * REST controller for managing {@link kz.gelleson.findep.domain.Location}.
 */
@RestController
@RequestMapping("/api")
