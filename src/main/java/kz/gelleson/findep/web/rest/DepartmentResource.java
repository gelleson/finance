...
import kz.gelleson.findep.domain.Department;
import kz.gelleson.findep.service.DepartmentService;
...
/**
 * REST controller for managing {@link kz.gelleson.findep.domain.Department}.
 */
@RestController
@RequestMapping("/api")
