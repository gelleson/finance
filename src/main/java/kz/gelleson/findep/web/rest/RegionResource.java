...
import kz.gelleson.findep.domain.Region;
import kz.gelleson.findep.service.RegionService;
...
/**
 * REST controller for managing {@link kz.gelleson.findep.domain.Region}.
 */
@RestController
@RequestMapping("/api")
