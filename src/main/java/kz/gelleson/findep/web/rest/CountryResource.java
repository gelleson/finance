...
import kz.gelleson.findep.domain.Country;
import kz.gelleson.findep.service.CountryService;
...
/**
 * REST controller for managing {@link kz.gelleson.findep.domain.Country}.
 */
@RestController
@RequestMapping("/api")
